        ...
        <div className="product-box product-wrap">
            <div className="img-wrapper">
                ...
                <div className={cartClass}>
                    ...
                    <Link to={null} title="Add to Wishlist" onClick={() => { addWishlist(product, product.Colors[indexColor]) }}>
                        <i className="fa fa-heart" aria-hidden="true"></i>
                    </Link>
                    <Link to={null} title="Quick View" onClick={toggle}>
                        <i className="fa fa-search" aria-hidden="true"></i>
                    </Link>
                    <Link to={null} title="Compare" onClick={toggleCompare}>
